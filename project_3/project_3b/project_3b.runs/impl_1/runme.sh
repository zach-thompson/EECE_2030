...
HD_PWD='C:/Users/Zach/Desktop/Work/School/Digital Electronics/VHDL Stuff/project_3/project_3b/project_3b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_displayASCII.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_displayASCII.tcl -notrace
