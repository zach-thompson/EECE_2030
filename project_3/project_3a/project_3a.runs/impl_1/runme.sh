...
HD_PWD='C:/Users/Zach/Desktop/Work/School/Digital Electronics/VHDL Stuff/project_3/project_3a/project_3a.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_displayBCD.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_displayBCD.tcl -notrace
