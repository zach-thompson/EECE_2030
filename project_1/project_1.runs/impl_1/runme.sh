...
HD_PWD='C:/Users/Zach/Desktop/Work/School/Digital Electronics/VHDL/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_hello_LED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_hello_LED.tcl -notrace
