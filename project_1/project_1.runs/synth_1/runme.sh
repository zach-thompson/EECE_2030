...
HD_PWD='C:/Users/Zach/Desktop/Work/School/Digital Electronics/VHDL/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_hello_LED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_hello_LED.tcl
