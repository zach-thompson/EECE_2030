...
HD_PWD='C:/Users/Zach/Desktop/Work/School/Digital Electronics/VHDL Stuff/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_rg_LED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_rg_LED.tcl
