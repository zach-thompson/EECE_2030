...
HD_PWD='C:/Users/Zach/Desktop/Work/School/Digital Electronics/VHDL Stuff/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_rg_LED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_rg_LED.tcl -notrace
